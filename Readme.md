...
2. คัดลอกโค้ดในโฟลเดอร์ Firebase > Lab-5-2-Firebase.ino
...
<h2>ส่งค่าขึ้นฐานข้อมูล MySQL</h2>

1. ดูวิธีการสร้าง database ที่ลิงค์ https://www.youtube.com/watch?v=F5T8isU13bU (ดูถึงแค่นาทีที่ 20) เนื้อหาในคลิปจะเป็นการใช้งาน 000webhost แต่ให้นักศึกษาใช้ hosting ของ infinityFree (หรือ host อื่นๆ) แทน
...
4. เปลี่ยนค่าการเชื่อมต่อข้อมูลในไฟล์ con_db.php ให้เป็นข้อมูล hosting ของตัวเอง
5. เขียนโปรแกรมฝั่ง esp32 โดยดาวน์โหลดไฟล์ Lab-5-2-MySQL.ino ได้ที่โฟลเดอร์ MySQL
6. เปลี่ยนค่า WiFi และ servername ให้เป็นของตัวเอง
6. ส่งค่าจริงจากเซ็นเซอร์ไปยังฐานข้อมูล
