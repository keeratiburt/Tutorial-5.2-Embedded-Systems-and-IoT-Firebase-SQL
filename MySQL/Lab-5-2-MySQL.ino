...
// เมื่อนำเซ็นเซอร์มาต่อจริง จะต้องกำหนดค่าเริ่มต้นให้เป็น 0
float esp_temp = 25.5;
float esp_humid = 79;


const char* serverName = "https://xxxxxxxxxx.000webhostapp.com/data_receive.php"; // ระบุ URL ของเว็บไซต์ของตัวเอง ระบุ path และลงท้ายด้วยชื่อไฟล์ data_receive.php เป็นการส่งค่าเข้าไฟล์นี้
